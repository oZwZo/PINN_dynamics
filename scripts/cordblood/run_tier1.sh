#!/usr/bin/env bash
# Interactive (single-task or sequential) runner for tier-1.
#
# Usage:
#   # Run a single task (by manifest row index, 0-based)
#   bash scripts/cordblood/run_tier1.sh 0
#
#   # Run all tier-1 tasks sequentially (slow)
#   bash scripts/cordblood/run_tier1.sh all
