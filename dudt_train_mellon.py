...
optional_args.add_argument("-M", "--model", type=str, required=False, default="log_pde_params", help='the model class, defined in models.py')
...
optional_args.add_argument("--model_note", type=str, required=False, default=None, help='in what name to save the model')
